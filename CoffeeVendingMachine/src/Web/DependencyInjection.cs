...
using CoffeeVendingMachine.Web.Services;
...
public static class DependencyInjection
{
    public static IServiceCollection AddWebServices(this IServiceCollection services)
    {
        ...
        services.AddHealthChecks()
            .AddDbContextCheck<CoffeeVendingMachine.Infrastructure.Data.CoffeeDbContext>();
        ...
        {
            configure.Title = "CoffeeVendingMachine API";
